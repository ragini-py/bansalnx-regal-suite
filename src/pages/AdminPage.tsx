...
import { AdminGuard, AdminLayout, AdminPage as AdminPageLayout, StatusBadge } from "@/components/admin/AdminLayout";
...
function DashboardContent() {
  ...
  return (
    <AdminPageLayout title="Operational overview" description="Orders and shipping status at a glance — no analytics, just what needs doing.">
                ...
                {needsAttention.map((o) => (
                  <TableRow key={o.id}>
                    ...
                    <TableCell className="text-right">
                      <Link to="/admin" className="text-xs text-foreground link-underline">
                        Review
                      </Link>
                    </TableCell>
                  </TableRow>
