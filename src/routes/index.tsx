...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Bansal-nx — Luxury Indian Couture, Handcrafted in Jaipur" },
      {
        name: "description",
        content:
          "Hand-embroidered lehengas, sarees, gowns and kurta sets from the Bansal-nx atelier. Made to order in Jaipur. Crafted for the extraordinary you.",
      },
      { property: "og:title", content: "Bansal-nx — Luxury Indian Couture" },
      {
        property: "og:description",
        content:
          "Editorial couture from our Jaipur atelier: zardozi, chikankari and handloom weaves, made to order.",
      },
    ],
  }),
  component: HomePage,
