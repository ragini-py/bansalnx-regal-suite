...
export const Route = createFileRoute("/register")({
  ...
  head: () => ({
    meta: [
      { title: "Create Account | Bansal-nx" },
      { name: "description", content: "Create a Bansal-nx account for faster checkout, order tracking and a saved wishlist." },
      { property: "og:title", content: "Create Account | Bansal-nx" },
      { property: "og:description", content: "Create a Bansal-nx account for faster checkout, order tracking and a saved wishlist." },
    ],
  }),
});
      ...
      <div className="flex items-center justify-center bg-background px-5 py-16 sm:px-10">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" search={{ redirect }} className="text-foreground link-underline">
              Sign in
            </Link>
          </p>
        </div>
