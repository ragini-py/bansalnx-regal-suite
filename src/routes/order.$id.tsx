...
export const Route = createFileRoute("/order/$id")({
  ...
  head: () => ({
    meta: [
      { title: "Order Confirmed | Bansal-nx" },
      { name: "description", content: "Your Bansal-nx order confirmation." },
      { property: "og:title", content: "Order Confirmed | Bansal-nx" },
      { property: "og:description", content: "Your Bansal-nx order confirmation." },
    ],
  }),
});
      ...
      <div className="mx-auto max-w-3xl px-5 py-14 sm:px-8">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <Button asChild variant="luxeOutline" size="luxe" className="flex-1">
            <Link to="/track" search={{ id: order.id }}>Track Order</Link>
          </Button>
          <Button asChild variant="luxeOutline" size="luxe" className="flex-1">
            <Link to="/products">Continue Shopping</Link>
          </Button>
