...
export const Route = createFileRoute("/cart")({
  ...
  head: () => ({
    meta: [
      { title: "Your Bag | Bansal-nx" },
      { name: "description", content: "Review the pieces in your bag before checkout at Bansal-nx." },
      { property: "og:title", content: "Your Bag | Bansal-nx" },
      { property: "og:description", content: "Review the pieces in your bag before checkout at Bansal-nx." },
    ],
  }),
});
            ...
            <ul className="divide-y divide-border border-y border-border">
              {cartLines.map((line) => (
                <li key={line.variantId} className="flex gap-5 py-7">
                  <Link to="/products/$slug" params={{ slug: line.product.slug }} className="shrink-0">
                    <img
