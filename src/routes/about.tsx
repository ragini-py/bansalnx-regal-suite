...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "Our Story | Bansal-nx" },
      { name: "description", content: "Bansal-nx is an atelier in Jaipur crafting made-to-order fashion with our karigars, honouring the peacock as a symbol of grace." },
      { property: "og:title", content: "Our Story | Bansal-nx" },
      { property: "og:description", content: "Bansal-nx is an atelier in Jaipur crafting made-to-order fashion with our karigars, honouring the peacock as a symbol of grace." },
    ],
  }),
});
