...
export const Route = createFileRoute("/returns")({
  ...
  head: () => ({
    meta: [
      { title: "Returns & Exchanges | Bansal-nx" },
      { name: "description", content: "Our returns and exchange policy, plus the full return status flow." },
      { property: "og:title", content: "Returns & Exchanges | Bansal-nx" },
      { property: "og:description", content: "Our returns and exchange policy, plus the full return status flow." },
    ],
  }),
});
