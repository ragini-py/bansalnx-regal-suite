...
export const Route = createFileRoute("/account/")({
  ...
  head: () => ({
    meta: [
      { title: "My Account | Bansal-nx" },
      { name: "description", content: "Manage your Bansal-nx orders, wishlist, addresses and profile." },
      { property: "og:title", content: "My Account | Bansal-nx" },
      { property: "og:description", content: "Manage your Bansal-nx orders, wishlist, addresses and profile." },
    ],
  }),
});
  ...
  const cards = [
    {
      ...
      to: mostRecentOrder ? `/account/orders/${mostRecentOrder.id}` : "/account/orders",
    },
    {
      label: "Wishlist",
