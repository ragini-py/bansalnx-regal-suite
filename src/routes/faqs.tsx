...
export const Route = createFileRoute("/faqs")({
  ...
  head: () => ({
    meta: [
      { title: "FAQs | Bansal-nx" },
      { name: "description", content: "Answers on sizing, made-to-order timelines, payments, returns, care and your account." },
      { property: "og:title", content: "FAQs | Bansal-nx" },
      { property: "og:description", content: "Answers on sizing, made-to-order timelines, payments, returns, care and your account." },
    ],
  }),
});
