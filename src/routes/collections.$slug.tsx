...
export const Route = createFileRoute("/collections/$slug")({
  head: () => ({
    meta: [
      { title: "Collection — Bansal-nx Atelier Edit" },
      {
        name: "description",
        content:
          "A curated Bansal-nx edit of hand-embroidered couture, made to order in our Jaipur atelier.",
      },
      { property: "og:title", content: "Collection — Bansal-nx Atelier Edit" },
      {
        property: "og:description",
        content: "A curated edit of hand-embroidered Bansal-nx couture.",
      },
    ],
  }),
