...
export const Route = createFileRoute("/track")({
  ...
  head: () => ({
    meta: [
      { title: "Track Your Order | Bansal-nx" },
      { name: "description", content: "Track the status and delivery of your Bansal-nx order." },
      { property: "og:title", content: "Track Your Order | Bansal-nx" },
      { property: "og:description", content: "Track the status and delivery of your Bansal-nx order." },
    ],
  }),
});
