...
export const Route = createFileRoute("/forgot-password")({
  ...
  head: () => ({
    meta: [
      { title: "Forgot Password | Bansal-nx" },
      { name: "description", content: "Reset the password for your Bansal-nx account." },
      { property: "og:title", content: "Forgot Password | Bansal-nx" },
      { property: "og:description", content: "Reset the password for your Bansal-nx account." },
    ],
  }),
});
