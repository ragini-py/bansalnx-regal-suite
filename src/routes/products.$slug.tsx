...
export const Route = createFileRoute("/products/$slug")({
  head: () => ({
    meta: [
      { title: "Product — Handcrafted Couture | Bansal-nx" },
      {
        name: "description",
        content:
          "A made-to-order Bansal-nx piece: hand embroidery, natural fibres and atelier finishing. View sizes, colours, fabric and care.",
      },
      { property: "og:title", content: "Handcrafted Couture | Bansal-nx" },
      {
        property: "og:description",
        content: "Made to order in our Jaipur atelier — hand embroidery on natural fibres.",
      },
    ],
  }),
        ...
        <Breadcrumbs
          items={[
            { label: "Home", href: <Link to="/" className="link-underline">Home</Link> },
            {
              label: "Shop",
              href: (
                <Link to="/products" search={{}} className="link-underline">
                  Shop
                </Link>
              ),
            },
