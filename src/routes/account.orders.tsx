...
export const Route = createFileRoute("/account/orders")({
  ...
  head: () => ({
    meta: [
      { title: "My Orders | Bansal-nx" },
      { name: "description", content: "View and track your Bansal-nx orders." },
      { property: "og:title", content: "My Orders | Bansal-nx" },
      { property: "og:description", content: "View and track your Bansal-nx orders." },
    ],
  }),
});
