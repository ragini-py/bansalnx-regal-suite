...
export const Route = createFileRoute("/reset-password")({
  ...
  head: () => ({
    meta: [
      { title: "Reset Password | Bansal-nx" },
      { name: "description", content: "Choose a new password for your Bansal-nx account." },
      { property: "og:title", content: "Reset Password | Bansal-nx" },
      { property: "og:description", content: "Choose a new password for your Bansal-nx account." },
    ],
  }),
});
