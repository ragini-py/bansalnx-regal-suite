...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Sign In | Bansal-nx" },
      { name: "description", content: "Sign in to your Bansal-nx account to manage orders, wishlist and addresses." },
      { property: "og:title", content: "Sign In | Bansal-nx" },
      { property: "og:description", content: "Sign in to your Bansal-nx account to manage orders, wishlist and addresses." },
    ],
  }),
});
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center bg-background px-5 py-16 sm:px-10">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 border border-border px-4 py-3 text-xs leading-relaxed text-muted-foreground">
            <p className="mb-1 font-medium uppercase tracking-[0.15em] text-foreground/80">Demo accounts</p>
            <p>Password for all: <span className="font-medium text-foreground">password</span></p>
